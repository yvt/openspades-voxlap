...
extern "C" {
#endif
char *sptr[(VSID*VSID*4)/3] asm("sptr");
#ifdef __cplusplus
}
#endif
...
long skyoff asm("skyoff") = 0, skyxsiz asm("skyxsiz"), *skylat asm("skylat") = 0;

int64_t gi asm("gi"), gcsub[8] asm("gcsub") =
{
	0xff00ff00ff00ff,0xff00ff00ff00ff,0xff00ff00ff00ff,0xff00ff00ff00ff,
	0xff00ff00ff00ff,0xff00ff00ff00ff,0xff00ff00ff00ff,0xff00ff00ff00ff
};
long gylookup[512+36] asm("gylookup"), gmipnum asm("gmipnum") = 0; //256+4+128+4+64+4+...
long gpz[2] asm("gpz"), gdz[2] asm("gdz"), gxmip asm("gxmip"), gxmax asm("gxmax");
long gixy[2] asm("gixy"), gpixy asm("gpixy");
...
static inline void expandbit256 (void *_s, void *_d)
{
...
EXTERN_C __ALIGN(16) point4d caddasm[8]         asm("caddasm") = {};
EXTERN_C __ALIGN(16) point4d ztabasm[MAXZSIZ+3] asm("ztabasm") = {};
EXTERN_C __ALIGN(16) unsigned short qsum0[4]    asm("qsum0")   = {}; //[8000h-hy,8000h-hx,8000h-hy,8000h-hx]
EXTERN_C __ALIGN(16) unsigned short qsum1[4]    asm("qsum1")   = {}; //[8000h-fy,8000h-fx,8000h-fy,8000h-fx]
__ALIGN(16) unsigned short qbplbpp[4]  asm("qbplbpp") = {}; //[0,0,bpl,bpp]
__ALIGN(16) int64_t kv6colmul[256]     asm("kv6colmul") = {};
__ALIGN(16) int64_t kv6coladd[256]     asm("kv6coladd") = {};
EXTERN_C __ALIGN(16) long kv6frameplace         asm("kv6frameplace")   = 0;
__ALIGN(16) long kv6bytesperline       asm("kv6bytesperline") = 0;
__ALIGN(16) float scisdist             asm("scisdist")  = 0;
...
char ptfaces16[43][8] asm("ptfaces16") =
{
...
void drawboundcubesseinit () asm("drawboundcubesseinit");
void drawboundcubesse (kv6voxtype *, long) asm("drawboundcubesse");
void drawboundcube3dninit () asm("drawboundcube3dninit");
void drawboundcube3dn (kv6voxtype *, long) asm("drawboundcube3dn");
